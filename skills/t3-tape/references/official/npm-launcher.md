...
The launcher forwards directly into the Rust CLI. PatchMD state still lives in the repo under `.t3/patch.md` plus `.t3/patch/`; there is no separate Node-side store.
